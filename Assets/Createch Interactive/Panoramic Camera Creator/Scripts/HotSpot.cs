...
public class HotSpot : MonoBehaviour 
{
	...
	public void Execute(string message)
	{
		...
		if(playsSound && soundToPlay != null)
		{
			...
			GetComponent<AudioSource>().audio.clip = soundToPlay ;
	...
	public void SendHotSpotIdInternal()
	{
		...
		{
			objectToSendIdTo.SendMessage(nameOfRecievingMethod,SendMessageOptions.RequireReceiver) ;
		}
		else
		{
			objectToSendIdTo.SendMessage(nameOfRecievingMethod,SendMessageOptions.DontRequireReceiver) ;
		}
	}
	#endregion
