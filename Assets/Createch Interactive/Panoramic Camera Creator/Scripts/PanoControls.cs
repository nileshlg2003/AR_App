...
public class PanoControls : MonoBehaviour 
{
	...
	void Start()
	{
		...
		if((panoCamera.fov != maxZoomFov) && limitXRotation)
		{
	...
	void DoInitialChecks()
	{
		...
		if(minZoomFov == maxZoomFov && panoCamera.fov != maxZoomFov)
		{
		...
		if(panoCamera.fov < minZoomFov || panoCamera.fov > maxZoomFov)
		{
	...
	{
		panZoomOffset = (maxZoomFov - panoCamera.fov) ;
